...
var secretPattern = regexp.MustCompile(`(sk-[A-Za-z0-9_-]{16,}|ghp_[A-Za-z0-9]{20,}|tskey-[A-Za-z0-9-]{10,}|Bearer\s+[A-Za-z0-9._-]{16,}` +
	`|(?i:token|secret|password|api[_-]?key)\s*[:=]\s*\S{8,})`)
