...
candidate_sha = "ec9873d6a06e623e0838e27dd8e9e6aab4fcb722c2758192e497d7c54da4f2a3"
...
evidence = {
    ...
    "results": results,
    "requests": requests,
    "limit": "Serialization/output/capability smoke only; independent QA #4006 covers store semantics and transition enforcement.",
}
pathlib.Path(__file__).with_suffix(".json").write_text(json.dumps(evidence, indent=2) + "\n")
print(json.dumps({"pass": len(results), "requests": len(requests), "limit": evidence["limit"]}))
